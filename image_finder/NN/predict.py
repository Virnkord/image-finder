...
def nn_filter(imagePaths, model, lb, keyword):
...
if __name__ == "__main__":
	...
	model = os.path.abspath(load_model(config.MODEL_PATH))
	lb = pickle.loads(open(os.path.abspath(config.LB_PATH), "rb").read())
